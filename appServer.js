...
// Query Heat Map to pass through python module
app.get('/api/verify_heat_map/:hm', async function(req, res){
    console.log("Verifying heatmap...");
        var key = req.params.hm
...
// Add Heat Map to chain 
app.post('/api/add_heat_map/', async function(req, res){
...
app.post('/api/register_user/', async function(req, res){

    var array = req.params.split("-");
    console.log(array);
    var user_val = array[0]
